...
echo "$smbu"
read -sp 'Enter SMB user password: ' smbp
echo
smbg=smb_group
echo "$smbg"
...
sudo dnf -y install nano net-tools
...
sudo shutdown -r +1 "System will reboot in 1 minute to complete setup."
